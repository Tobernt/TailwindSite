const translations = {
  ...
  sv: {
    ...
    'education.frontend.title': 'Frontend & arkitektur',
    'education.frontend.react': 'React — Bygg UI med komponenter',
    'education.frontend.nextjs': 'Next.js — React + server + routing + prestanda',
    'education.frontend.tailwind': 'Tailwind — CSS-klasser som du bygger UI med direkt',
    'education.frontend.designsystem': 'Designsystem — Enhetliga UI-regler och färdiga komponenter',
    'education.frontend.headlesscms': 'Headless CMS — Innehåll via API, inte bundet till HTML',
    'education.frontend.graphql': 'GraphQL — Fråga efter exakt data',
    'education.frontend.oauth': 'OAuth — Säker inloggning via tokens',
    'education.frontend.nx': 'NX — Struktur för stora projekt',
    'education.frontend.testing': 'Vitest/Cypress — Testning',
