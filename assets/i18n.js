const translations = {
  en: {
    ...
    'contact.eyebrow': 'UI gallery',
    'contact.title': 'Ready to start a project?',
    'contact.subtitle': 'Book a walkthrough of your challenges or request a small prototype. I respond within one business day.',
    'contact.ctaPrimary': 'Contact me',
    'contact.ctaSecondary': 'Explore solutions in the gallery',
    'contact.tag.workshop': 'Available for workshops',
    'contact.tag.response': 'Replying ASAP',
    'contact.tag.demo': 'Includes recorded demo',
    'contact.tag.availability': 'Available for freelance gigs, contracts, short & long term, remote',
    'contact.form.title': 'Contact form',
    'contact.form.tag': 'WCAG tested',
    'contact.form.name': 'Name',
    'contact.form.email': 'Email',
    'contact.form.message': 'What do you want to achieve?',
    'contact.form.note': 'Demo only: nothing is saved or sent. Use Contact me to reach out for real.',
    'contact.form.submit': 'Send',
    'contact.invalid': 'Fill in all fields (demo only—no email is sent).',
    'contact.success': 'Demo form validated. Use Contact me to start a real conversation.',
    'gradient.activate': 'Activate gradient',
    'gradient.deactivate': 'Close gradient',
    'gallery.contactForm.title': 'WCAG contact form',
    'gallery.contactForm.tag': 'Form',
    'gallery.contactForm.summary': 'Same responsive form as the home page, kept as a demo only so no emails are sent.',
    'gallery.contactForm.subtitle': 'Mobile-friendly and keyboard ready',
    'gallery.contactForm.details': 'Focus order, labels and contrast are WCAG tested. On mobile the layout stacks with large tap targets.',
    'gallery.contactForm.availability': 'Available for freelance gigs, contracts, short & long term, remote',
    'gallery.contactForm.note': 'Demo only: nothing is saved or sent—use the Contact me link to start a real conversation.',
    'gallery.contactForm.label': 'Contact form example',
    'gallery.contactForm.badge': 'WCAG tested',
    'gallery.contactForm.disclaimer': 'This UI is a showcase and does not send emails. It highlights accessible validation states.',
    'gallery.contactForm.submit': 'Validate demo form',
  },
  sv: {
    ...
    'contact.ctaPrimary': 'Kontakta mig',
    ...
    'contact.tag.availability': 'Tillgänglig för frilansuppdrag, korta & långa kontrakt, remote',
    ...
    'contact.form.note': 'Demo: inget sparas eller skickas. Använd Kontakta mig-länken för riktig kontakt.',
    ...
    'gallery.contactForm.title': 'WCAG-kontaktformulär',
    'gallery.contactForm.tag': 'Formulär',
    'gallery.contactForm.summary': 'Samma responsiva formulär som på startsidan, men bara som demo utan mejlutskick.',
    'gallery.contactForm.subtitle': 'Mobilanpassat och tangentbordsredo',
    'gallery.contactForm.details': 'Fokusordning, etiketter och kontrast är WCAG-testade. På mobil staplas fälten med stora klickytor.',
    'gallery.contactForm.availability': 'Tillgänglig för frilans, korta & långa uppdrag, remote',
    'gallery.contactForm.note': 'Demo: inget sparas eller skickas – använd Kontakta mig-länken för riktig dialog.',
    'gallery.contactForm.label': 'Exempel på kontaktformulär',
    'gallery.contactForm.badge': 'WCAG testat',
    'gallery.contactForm.disclaimer': 'Detta är en UI-demonstration och skickar inga mejl. Visar tillgängliga valideringslägen.',
    'gallery.contactForm.submit': 'Validera demoformuläret',
    ...
    'contact.invalid': 'Fyll i alla fält (demo – inget mejl skickas).',
    'contact.success': 'Demoformulär klart. Använd Kontakta mig-länken för riktig dialog.',
